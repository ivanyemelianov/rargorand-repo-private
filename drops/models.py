...
class Drop(models.Model):
    ...
    release_date = models.CharField(max_length=250, blank=False, null=True)
    release_time = models.TimeField(auto_now=False, auto_now_add=False, default=None, blank=False, null=True)
